...
public class WhoisGUI extends JFrame {
    ...
    private final JTextField searchString = new JTextField(30);
    private final JTextArea names = new JTextArea(15, 80);
    private final JButton findButton = new JButton("Find");
    private final ButtonGroup searchIn = new ButtonGroup();
    private final ButtonGroup searchFor = new ButtonGroup();
    private final JCheckBox exactMatch = new JCheckBox("Exact Match", true);
    private final JTextField chosenServer = new JTextField();
